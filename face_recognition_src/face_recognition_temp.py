...
# 	def createDirectory(self, person_name):
# 		data_folder_name = "face_recognition/data" + os.path.sep + person_name
# 		os.mkdir(data_folder_name)

# 	def storeTrainingImages(self):
...
#     detected_faces = face_cascade.detectMultiScale(grayscale_image, scaleFactor=1.2, minNeighbors=5);
...
#     return grayscale_image[y:y+w, x:x+h], detected_faces[0]
